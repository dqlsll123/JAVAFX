...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //Media media = new Media("http://dalemusser.net/media/tomandjerry.mp4");
        Media media = new Media(this.getClass().getResource("tomandjerry.mp4").toExternalForm());
        ...
        // Example of Runnable instread of lambda expression
